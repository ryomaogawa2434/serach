...
ans_list,pred_list=personal.main2()
sum_ans_list=ans_list
sum_pred_list=pred_list
ex_ans_list=ans_list
ex_pred_list=pred_list
...
ex_ans_list=ex_ans_list+ans_list
ex_pred_list=ex_pred_list+pred_list

print("\n")
print("全体総合")
cm = confusion_matrix(ex_ans_list,ex_pred_list)
print('混同行列(confusion matrix)')
print(cm)
print('正解率')
acu=recall_score(ex_ans_list,ex_pred_list,average=None)
print(acu)
print('全体正解率(accuracy)')
print(accuracy_score(ex_ans_list,ex_pred_list))
acu_all=accuracy_score(ex_ans_list,ex_pred_list)
print('適合率(precision)')
prec=precision_score(ex_ans_list,ex_pred_list,average=None)
print(prec)
print('全体適合率')
print(precision_score(ex_ans_list,ex_pred_list,average='macro'))
prec_all=precision_score(ex_ans_list,ex_pred_list,average='macro')
print('再現率(recall)')
reca=recall_score(ex_ans_list,ex_pred_list,average=None)
print(reca)
print('全体再現率')
print(recall_score(ex_ans_list,ex_pred_list,average='macro'))
reca_all=recall_score(ex_ans_list,ex_pred_list,average='macro')
print('F値(F-measure)')
fsco=f1_score(ex_ans_list,ex_pred_list,average=None)
print(fsco)
print('全体F値')
print(f1_score(ex_ans_list,ex_pred_list,average='macro'))
fsco_all=f1_score(ex_ans_list,ex_pred_list,average='macro')
...
df_v.to_csv("Result23.csv")
with open('Result23.csv', 'a') as f:
    writer = csv.writer(f)
